...
Rules execute by phase: <MethodRef>PIPELINE_RULES</MethodRef>, <MethodRef>AGENT_POST_INTENT</MethodRef>, <MethodRef>MCP_POST_LLM</MethodRef>, and <MethodRef>TOOL_POST_EXECUTION</MethodRef>.
</Highlight>
