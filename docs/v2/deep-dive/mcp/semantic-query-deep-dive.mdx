...
export const nodes = [
  ...
  { id: "p", data: { label: "2. AgentPlanner" } },
...
<DbTable
  ...
  rows={[
    ["Java (AgentPlanner)", "loaded tool metadata", "semantic chain should run"],
