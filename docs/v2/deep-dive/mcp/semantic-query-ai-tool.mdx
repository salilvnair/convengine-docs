...
```sql
SELECT 'ce_semantic_model' AS table_name, COUNT(*) AS row_count FROM ce_semantic_model
UNION ALL SELECT 'ce_semantic_setting', COUNT(*) FROM ce_semantic_setting
UNION ALL SELECT 'ce_semantic_source_table', COUNT(*) FROM ce_semantic_source_table
UNION ALL SELECT 'ce_semantic_source_column', COUNT(*) FROM ce_semantic_source_column
UNION ALL SELECT 'ce_semantic_lexicon', COUNT(*) FROM ce_semantic_lexicon
UNION ALL SELECT 'ce_semantic_rule_allowed_table', COUNT(*) FROM ce_semantic_rule_allowed_table
UNION ALL SELECT 'ce_semantic_rule_deny_operation', COUNT(*) FROM ce_semantic_rule_deny_operation
UNION ALL SELECT 'ce_semantic_rule_config', COUNT(*) FROM ce_semantic_rule_config
UNION ALL SELECT 'ce_semantic_concept', COUNT(*) FROM ce_semantic_concept
