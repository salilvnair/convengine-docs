...
<DbTable
  ...
  rows={[
    ...
    ["Logical operators", "[[${context.mcp != null && context.agent.finalAnswer != null ? context.agent.finalAnswer : 'Pending'}]]", "Combines multiple checks before rendering."]
  ]}
/>
...
[[\${context.mcp != null && context.agent.finalAnswer != null ? context.agent.finalAnswer : 'Processing is still in progress.'}]]
```
