...
<DbTable
  ...
  rows={[
    ...
    ["ce_semantic_entity_override", "Entity-level override metadata.", "Patch entity behavior without code changes."],
    ["ce_semantic_relationship_override", "Relationship override metadata.", "Patch relationship/join behavior without code changes."],
