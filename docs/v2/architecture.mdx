...
<FlowStep step="3" title="v2 control steps run">
...
<Highlight type="info" title="v2 control phases">
Rules execute by phase in v2: <MethodRef>PIPELINE_RULES</MethodRef>, <MethodRef>AGENT_POST_INTENT</MethodRef>, <MethodRef>MCP_POST_LLM</MethodRef>, and <MethodRef>TOOL_POST_EXECUTION</MethodRef>.
</Highlight>
