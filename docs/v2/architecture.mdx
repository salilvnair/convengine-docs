...
- correction routing: <MethodRef>CorrectionStep</MethodRef>
...
Rules execute by phase: <MethodRef>PRE_RESPONSE_RESOLUTION</MethodRef>, <MethodRef>POST_AGENT_INTENT</MethodRef>, <MethodRef>POST_SCHEMA_EXTRACTION</MethodRef>, <MethodRef>PRE_AGENT_MCP</MethodRef>, <MethodRef>POST_AGENT_MCP</MethodRef>, and <MethodRef>POST_TOOL_EXECUTION</MethodRef>.
</Highlight>
