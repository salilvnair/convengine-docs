...
<Tabs groupId="bootstrap">
  ...
  <TabItem value="gradle" label="build.gradle.kts">
    ...
    {`implementation("com.github.salilvnair:convengine:1.0.11")`}
    </CodeBlockToggle>
...
<Tabs groupId="ce-ddl-dialect">
  <TabItem value="postgres" label="Postgres" default>
    <CodeBlockToggle title="Postgres DDL source" language="sql" packagePath="src/main/resources/sql">
...
-- (legacy path still available: src/main/resources/sql/ddl.sql)`}
  ...
  <TabItem value="oracle" label="Oracle">
    <CodeBlockToggle title="Oracle DDL source" language="sql" packagePath="src/main/resources/sql">
    {`-- Use full script from:
-- src/main/resources/sql/ddl_oracle.sql`}
    </CodeBlockToggle>
  </TabItem>
  <TabItem value="sqlite" label="SQLite">
    <CodeBlockToggle title="SQLite DDL source" language="sql" packagePath="src/main/resources/sql">
    {`-- Use full script from:
...
- <FileRef>src/main/resources/sql/ddl_postgres.sql</FileRef> (or legacy <FileRef>src/main/resources/sql/ddl.sql</FileRef>)
