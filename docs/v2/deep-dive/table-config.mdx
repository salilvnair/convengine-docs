...
<DbTable
  ...
  rows={[
    ...
    ["ce_semantic_entity_override", "Entity-level override metadata.", "SemanticInterpretService.", "Patch behavior without Java changes."],
    ["ce_semantic_relationship_override", "Relationship override metadata.", "SemanticInterpretService.", "Override join relationships without Java changes."],
...
<DbTable
  ...
  rows={[
    ...
    ["modelPath", "classpath:/mcp/semantic-layer.yml", "Semantic model path."],
