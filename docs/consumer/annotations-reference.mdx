...
See [Consumer Guide](/docs/consumer/), [New Consumer Onboarding](/docs/consumer/new-consumer-onboarding), and [Extensions](/docs/consumer/extensions) for end-to-end integration context.
</Highlight>
