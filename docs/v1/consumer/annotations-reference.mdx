...
1. Use only `@EnableConvEngine` initially.
...
See [Consumer Guide](/docs/v1/consumer/), [New Consumer Onboarding](/docs/v1/consumer/new-consumer-onboarding), and [Extensions](/docs/v1/consumer/extensions) for end-to-end integration context.
</Highlight>
